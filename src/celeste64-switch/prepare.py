...
mesa_worker = os.environ.get('CELESTE64_MESA_WORKER', '0')
if mesa_worker not in ('0', '1'): raise ValueError('CELESTE64_MESA_WORKER must be 0 or 1')
mesa_mode = 'on' if mesa_worker == '1' else None
mesa_archive_sha256 = None
if mesa_mode:
    from renderer.mesa import prepare_renderer
    mesa_archive_sha256 = prepare_renderer(out, root, mesa_mode)
