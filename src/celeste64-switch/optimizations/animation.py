...
import subprocess
COMMIT = '5a33d5452528d827ac55727f302d8a91a75c4186'

def optimize_animation(out, port, replace):
    upstream = port.parents[1] / 'third_party/upstream/sharpgltf-alpha0031'
    if not upstream.exists():
        raise RuntimeError('Run src/celeste64-switch/optimizations/bootstrap-animation.sh first')
